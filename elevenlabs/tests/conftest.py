"""Register the elevenlabs plugin as a Python package for tests."""
...
_pkg_name = "gilbert_plugin_elevenlabs"
...
if _pkg_name not in sys.modules:
    ...
    for _mod_name in ("elevenlabs_tts", "elevenlabs_scribe", "plugin"):
