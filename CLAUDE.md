...
- **Backend ABCs** — `AIBackend`, `TTSBackend`, `SpeakerBackend`, `MusicBackend`, `MediaLibraryBackend`, `AuthBackend`, `EmailBackend`, `DocumentBackend`, `VisionBackend`, `OCRBackend`, `TunnelBackend`, `WebSearchBackend`, `PresenceBackend`, `DoorbellBackend`, `CameraEventBackend`, `UserProviderBackend`. Set `backend_name = "…"` on the subclass and the ABC's `__init_subclass__` registers it automatically.
