"""Register the porcupine plugin as a Python package for tests.

Mirrors the convention used by the other std-plugins — the plugin
directory is registered as ``gilbert_plugin_porcupine`` so relative
...
_pkg_name = "gilbert_plugin_porcupine"
...
if _pkg_name not in sys.modules:
    ...
    for _mod_name in ("porcupine", "plugin"):
